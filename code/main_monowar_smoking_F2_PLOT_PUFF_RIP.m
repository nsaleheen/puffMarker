...
pid='p01';sid='s02';e=1;p=2; type='standing_acl';% standing
pid='p03';sid='s03';e=2;p=10; type='sitting_acl';  % sitting
pid='p03';sid='s03';e=1;p=6; type='walking_acl'; % walking
...
if id==1, IDS=[G.SENSOR.WL9_ACLXID:G.SENSOR.WL9_ACLZID]; else IDS=[G.SENSOR.WR9_ACLXID:G.SENSOR.WR9_ACLZID];end;
h=figure;hold on;
