...
%      {'p6000'},(cellstr(strcat('s',num2str([01,11,13]','%02d'))))';%01,02,11,12,13,14
% %      {'p6001'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%01,02,11,12,13,14
%      {'p6002'},(cellstr(strcat('s',num2str([01,02,11,12,13]','%02d'))))';%01,02,11,12,13,14
%      {'p6003'},(cellstr(strcat('s',num2str([01,02,11]','%02d'))))';%01,02,11,12,13,14
% %      {'p6007'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%01,02,11,12,13,14
%      {'p6008'},(cellstr(strcat('s',num2str([02,12]','%02d'))))';%01,02,11,12,13,14
% %      {'p6010'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%01,02,11,12,13,14
...
%      {'p6507'},(cellstr(strcat('s',num2str([01,02,11,12,13,14]','%02d'))))';%01,02,11,12,13,14
%     {'p6510'},(cellstr(strcat('s',num2str([01,02,11,12,13,14]','%02d'))))';%01,02,11,12,13,14
%     {'p6517'},(cellstr(strcat('s',num2str([01,02,11,13]','%02d'))))';%01,02,11,12,13,14
     % FALSE POS
%        {'p6001'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%01,02,11,12,13,14
...
%     {'p6512'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';
%     {'p6513'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%,
%     {'p6521'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';
%     {'p6522'},(cellstr(strcat('s',num2str([11,12,13]','%02d'))))';%01,02,11,12,13,14
%     {'p6006'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%01,02,
%     {'p6020'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%     
%1st lapes
...
% {'p6517'},(cellstr(strcat('s',num2str(11))))';%01,02,11,12,13,14
    %---nEW---
%  {'p6542'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6541'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6540'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6534'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6532'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6511'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6501'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%
%  {'p6023'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134]','%03d'))))';%
%  {'p6025'},(cellstr(strcat('s',num2str([111,112,113,114,121,122,123,124,131,132,133,134,141,142,143,144]','%03d'))))';%

%  {'p6542'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';% 
%  {'p6541'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%  {'p6540'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%  {'p6534'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%  {'p6532'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%  {'p6511'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%  {'p6501'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%   {'p6023'},(cellstr(strcat('s',num2str([11,12,13]','%02d'))))';%
%  {'p6025'},(cellstr(strcat('s',num2str([11,12,13,14]','%02d'))))';%
%  
%   {'p6532'},(cellstr(strcat('s',num2str([1, 2]','%02d'))))';%

% {'p6023'},(cellstr(strcat('s',num2str(13))))';%01,02,11,12,13,14
