...
%  plot_custom(G,pid,sid,'svm_output','plot_puff_gyr_groundtruth_graph',[],'smokinglabel','gyrmag',[2],'segment_gyr','map',[2],'selfreport','svm');
time=[15,5];
 plot_smoking_segment_withpuff(G,pid,sid,'svm_output','plot_puff_gyr_groundtruth_graph',time);
        disp('abc');
        break;
    end
end
