function [h,legend_text]=plot_rr_avg_threshold_macd_recovery(G,pid,sid)
hh = figure();
...
%            p=patch([stime etime etime stime],[400 400 1700 1700],[1,0.4,0.4],'edgecolor','none');            
            ...
            plot_signal(stime,P.rr.avg.t60(P.rr.window.c1(i)),'r*',5);
            plot_signal(etime,P.rr.avg.t60(P.rr.window.c2(i)),'r*',5);
            stime=P.rr.avg.matlabtime(P.rr.window.p1(i));
            etime=P.rr.avg.matlabtime(P.rr.window.v1(i));
...
%            p=patch([stime etime etime stime],[400 400 1700 1700],[1,0.7,0.7],'edgecolor','none');
            stime=P.rr.avg.matlabtime(P.rr.window.a1(i));
            etime=P.rr.avg.matlabtime(P.rr.window.a2(i));
            plot_signal(stime,P.rr.avg.t60(P.rr.window.a1(i)),'r*',2);
            plot_signal(etime,P.rr.avg.t60(P.rr.window.a2(i)),'r*',2);
...
temp=[G.DIR.DATA G.DIR.SEP 'figure_5' G.DIR.SEP pid '_' sid '.jpg'];
export_fig(temp);
close(hh);
