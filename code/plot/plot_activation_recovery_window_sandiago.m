function [h,legend_text]=plot_activation_recovery_window_sandiago(G,pid,sid,wlarge,wsmall,field)
hh = figure();
...
h(3)=plot_signal(P.acl.avg60.matlabtime,val60,'g-',1,1400);legend_text{3}='Activity Indicator (ACCEL)';
