function G=config_run_monowar_nida(G)
G.STUDYNAME='NIDA';
G.TIME.TIMEZONE=-5;
...
{'p15'}, {'s02','s10','s13'};
{'p27'}, {'s13','s20'};
{'p28'}, {'s16','s32','s34'};%{'p34'}, {'s10'};
%{'p38'}, {'s26'};
{'p39'}, {'s15','s24'};
{'p41'}, {'s11','s13','s19','s27','s31'};    
    %}
% Non cocaine
%{
{'p01'}, {'s19','s23'};
{'p03'},{'s01','s02','s03','s04','s05','s06','s07','s08','s09','s10','s11','s12','s13','s14','s15','s16','s19','s20','s21','s22','s23','s24','s25','s26','s27'};
{'p06'}, {'s30','s07','s11'};
{'p09'}, {'s07','s02'};
{'p12'}, {'s13','s20','s25'};
{'p14'}, {'s02','s03','s04','s05','s06','s21','s22','s23'};
{'p15'}, {'s01','s03','s06'};
{'p27'}, {'s04','s05','s15','s25'};
{'p28'}, {'s02','s11','s12','s13','s20','s25'};
%{'p34'}, {'s01','s02','s03','s04','s05','s06','s07','s08','s20','s21','s22','s27','s28','s33','s34'};
{'p39'},{'s08','s07','s16','s18'};
{'p41'},{'s06','s08','s10','s12'};
 %}   

    % all
{'p01'}, {'s04','s10','s16','s21','s19','s23'};
{'p03'}, {'s18','s01','s02','s03','s04','s05','s06','s07','s08','s09','s10','s11','s12','s13','s14','s15','s16','s19','s20','s21','s22','s23','s24','s25','s26','s27'};
{'p06'}, {'s01','s03','s32','s30','s07','s11'};
{'p09'}, {'s10','s07','s02'};
{'p12'}, {'s10','s13','s20','s25'};
{'p14'}, {'s16','s02','s03','s04','s05','s06','s21','s22','s23'};
{'p15'}, {'s02','s10','s13','s01','s03','s06'};
{'p27'}, {'s20','s04','s05','s15','s25'};
{'p28'}, {'s16','s32','s34','s02','s11','s12','s13','s20','s25'};
{'p39'}, {'s15','s24','s08','s07','s16','s18'};
{'p41'}, {'s11','s13','s19','s27','s31','s06','s08','s10','s12'};    
};
...
%{'p27'}, {'s13','s19','s20','s27','s31'};
%{'p28'}, {'s16','s32','s34','s02','s11','s12','s13','s20','s25','s01','s02','s03','s04','s05','s06','s07','s08','s20','s21','s22','s27','s28','s33','s34'};
%{'p34'}, {'s10'};{'p38'}, {'s26'};{'p39'}, {'s15','s17','s24'};{'p41'}, {'s11','s13','s15','s16','s19','s21','s27'};
%}
%{
    ...
    {'p15'},(cellstr(strcat('s',num2str((1:25)','%02d'))))';
    
%    {'p18'},(cellstr(strcat('s',num2str((1:22)','%02d'))))';
%    {'p19'},(cellstr(strcat('s',num2str((1:26)','%02d'))))';
%    {'p21'},(cellstr(strcat('s',num2str((1:32)','%02d'))))';
    {'p27'},(cellstr(strcat('s',num2str((1:32)','%02d'))))';
    {'p28'},(cellstr(strcat('s',num2str((1:37)','%02d'))))';
    {'p34'},(cellstr(strcat('s',num2str((1:34)','%02d'))))';
%    {'p38'},(cellstr(strcat('s',num2str(([1:9, 11:32])','%02d'))))';
    {'p39'},(cellstr(strcat('s',num2str((1:28)','%02d'))))';
    {'p41'},(cellstr(strcat('s',num2str((1:33)','%02d'))))';
...
%{
    ...
    {'p26'},(cellstr(strcat('s',num2str((1:34)','%02d'))))';
     ...
     {'p30'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';
     ...
     {'p44'},(cellstr(strcat('s',num2str((9:9)','%02d'))))';
%}
%{
