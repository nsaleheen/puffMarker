function G=config_run_monowar_NIDAc(G)
G.STUDYNAME='NIDAc';
G.TIME.TIMEZONE=-5;
...
%subject and sessions are adjusted according to their actual study participation.
    ...
    {'p01'},(cellstr(strcat('s',num2str((1:12)','%02d'))))';
 	{'p02'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
 	{'p03'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
    {'p04'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
 	{'p05'},(cellstr(strcat('s',num2str((1:6)','%02d'))))';
 	{'p06'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
 	%{'p07'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
   };
