        ...
        for e=1:length(P.smoking_episode)
            ...
            for p=1:length(P.smoking_episode{e}.puff.timestamp)
                ...
                for id=1:2
                    ...
                    if id==1, IDS=G.SENSOR.WL9_ACLXID:G.SENSOR.WL9_GYRZID; else IDS=G.SENSOR.WR9_ACLXID:G.SENSOR.WR9_GYRZID;end;
...
%                     plot(P.wrist{id}.timestamp(ind)-stime, P.wrist{id}.magnitude_800(ind)+offset-1000,'-bo','markersize',4);
                    ...
                    filename=[G.DIR.DATA G.DIR.SEP 'plot_puff_R_A_G_M' G.DIR.SEP str '.png'];
