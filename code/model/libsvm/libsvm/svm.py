...
fillprototype(libsvm.svm_cross_validation, None, [POINTER(svm_problem), POINTER(c_int), POINTER(svm_parameter), c_int, POINTER(c_double)])
fillprototype(libsvm.svm_cross_validation_sepsets, None, [POINTER(svm_problem),POINTER(svm_problem), POINTER(c_int),POINTER(c_int), POINTER(svm_parameter), c_int, POINTER(c_double)])
fillprototype(libsvm.svm_cross_validation_labeltargets, None, [POINTER(svm_problem), POINTER(c_int), POINTER(svm_parameter), c_int, POINTER(c_double)])
