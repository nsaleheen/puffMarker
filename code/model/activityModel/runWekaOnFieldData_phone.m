...
function [predictedClass classTimestamp]=runWekaOnFieldData_phone(pid,sid)

cd C:\Users\mahbub\Desktop\ActivityClassifier\WithDriving\Testing\PhoneAccel
%file='memphis_f_p16_s05_a10_test_weka'
file=['memphis_f_' pid '_' sid '_a10_test_phone_weka'];
...
load(featureFile);
[r c]=size(F.sensor(4).feature);checkMatrix=ones(r,c);
addResult=F.sensor(4).feature+checkMatrix;
...
dir='C:\Users\mahbub\Desktop\ActivityClassifier\WithDriving\Testing\PhoneAccel';
%file='memphis_f_p16_s05_a10_test_weka';
...
outputfile=['C:\Users\mahbub\Desktop\ActivityClassifier\WithDriving\Testing\PhoneAccel\' file '_prediction.mat'];
