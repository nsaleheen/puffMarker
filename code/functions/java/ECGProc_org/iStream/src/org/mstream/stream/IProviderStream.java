...
/**
 * TODO: General Interface to be implemented by provider streams in iStream framework 
 * 
 * @author aparate
 *
 */
public interface IProviderStream<T> {
	...
	public void addChildStreams(IProviderStream... stream);
