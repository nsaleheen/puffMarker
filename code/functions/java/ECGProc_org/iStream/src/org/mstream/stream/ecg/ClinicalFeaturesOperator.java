...
/**
 * ECG Feature Extractor to get clinical features in each annotated RR sample.
 * <p>
 * The following clinical features are given as output in the given order:
 * <ol>
 ...
 */
public class ClinicalFeaturesOperator implements IStream<DoubleValuesItem>{
	...
	/**
	 * Constructor for {@link ClinicalFeaturesOperator}
	 * @param NSAMPLES number of interpolated points in an RR sample
	 */
	public ClinicalFeaturesOperator(int NSAMPLES){
	 ...
	 */
	public ClinicalFeaturesOperator(){
		NSAMPLES = 100;
	}
	...
	/**
	 * Saves feature vectors with timestamps. The feature vectors contain following in the given order
	 * <ol> 
	 * <li><b>RR:</b> The RR interval in seconds </li>
	 * <li><b>QT:</b> The QT distance is given as difference between index of T and index of Q in the fixed size
	...
	private boolean rExtractFeatures() {
		...
		Double vals[] = list.toArray(new Double[0]);
