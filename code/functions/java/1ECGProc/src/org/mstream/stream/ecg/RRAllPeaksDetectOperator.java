...
//		System.out.println(s);
		...
		if(maxima[T]<minima[S]) {
			failed[1]++;
//			System.out.println("rr "+(x++)+" f1="+failed[1]);
			return false;
		}
		//P follows T i.e. P>T
		if(maxima[P]<maxima[T]) {
			failed[2]++;
//			System.out.println("rr "+(x++)+" f2="+failed[2]);			
			return false;
		}
		//Q follows P i.e Q>P
		if(minima[Q]>maxima[P]) {
			failed[3]++;
//			System.out.println("rr "+(x++)+" f3="+failed[3]+" minima[Q]="+minima[Q]+" maxima[P]="+maxima[P]);			
//			return false;
		}
		//R follows Q i.e. R>Q
		if(maxima[R]<minima[Q]) {
			failed[4]++;
//			System.out.println("rr "+(x++)+" f4="+failed[4]);			
			return false;
		}
		//T from previous R >=20 i.e T>=20
		if(maxima[T]<20) {
			failed[5]++;
//			System.out.println("rr "+(x++)+" f5="+failed[5]);			
			return false;
		}
//		System.out.println("rr "+(x++)+" success");
	...
	private Integer[][] getAllPeakIndices(double values[], double delta)
	{
		...
		//System.out.println(out[0].length + " " + out[1].length);
		if(DEBUG) {
