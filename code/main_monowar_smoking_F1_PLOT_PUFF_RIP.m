...
if id==1, IDS=[G.SENSOR.WL9_GYRZID:-1:G.SENSOR.WL9_ACLXID]; else IDS=[G.SENSOR.WR9_GYRZID:-1:G.SENSOR.WR9_ACLXID];end;
h=figure;hold on;
...
for pp=p-1:p
plot(([P.smoking_episode{e}.puff.gyr.starttimestamp(pp),P.smoking_episode{e}.puff.gyr.starttimestamp(pp)]-stime)/1000,[0,750],'k-','linewidth',lw);
hold on;text((P.smoking_episode{e}.puff.gyr.starttimestamp(pp)-stime)/1000, 700  ,{' Hand';'   at';' Mouth'}, 'Color', 'k','FontSize',18);
...
filename=['C:\Users\smh\Desktop\smoking_fig' G.DIR.SEP  'moving_avg.png'];
