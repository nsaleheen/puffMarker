function G=config_run_activity(G)
G.STUDYNAME='activity';
G.TIME.TIMEZONE=-6;
...
%    {'p08'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
    {'p02'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
    {'p03'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
    {'p05'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
    {'p06'},(cellstr(strcat('s',num2str((1:2)','%02d'))))';
%    {'p07'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
};
%% Formatted Raw
