...
G.PS_LIST= {
<<<<<<< .mine
%       {'p12'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%      {'p13'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%      {'p14'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%      {'p15'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%      {'p16'},(cellstr(strcat('s',num2str((5:5)','%02d'))))';
%      {'p17'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%     {'p18'},(cellstr(strcat('s',num2str((5:5)','%02d'))))';
%     {'p19'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%    {'p20'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';    
%    {'p21'},(cellstr(strcat('s',num2str((1:7)','%02d'))))';
%    {'p22'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%    {'p24'},(cellstr(strcat('s',num2str((2:2)','%02d'))))';
    {'p25'},(cellstr(strcat('s',num2str((9:9)','%02d'))))';    
%    {'p26'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';
%    {'p27'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';
%    {'p28'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';
%    {'p29'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';    
%    {'p30'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';
%    {'p31'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
    {'p32'},(cellstr(strcat('s',num2str((3:3)','%02d'))))';
%    {'p33'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%    {'p34'},(cellstr(strcat('s',num2str((1:12)','%02d'))))';
%    {'p35'},(cellstr(strcat('s',num2str((1:13)','%02d'))))';
%    {'p36'},(cellstr(strcat('s',num2str((1:11)','%02d'))))';
%    {'p37'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
    {'p38'},(cellstr(strcat('s',num2str((3:3)','%02d'))))';
%    {'p39'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%    {'p40'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
%    {'p41'},(cellstr(strcat('s',num2str((1:11)','%02d'))))';
%   {'p42'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%    {'p43'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%    {'p44'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
=======
