...
G.PS_LIST= {
      {'p01'},(cellstr(strcat('s',num2str((1:1)','%02d'))))';
%     {'p13'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%     {'p14'},(cellstr(strcat('s',num2str((1:10)','%02d'))))';
%     {'p15'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%     {'p16'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
%     {'p17'},(cellstr(strcat('s',num2str((1:8)','%02d'))))';
%    {'p18'},(cellstr(strcat('s',num2str((1:19)','%02d'))))';
%     {'p19'},(cellstr(strcat('s',num2str((1:9)','%02d'))))';
...
%    {'p25'},(cellstr(strcat('s',num2str((1:30)','%02d'))))';    
