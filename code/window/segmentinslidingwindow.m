function window=segmentinslidingwindow(G,sensor,starttimestamp,endtimestamp,MODEL)
...
ind=0;
for i=starttimestamp:MODEL.WINDOW_SLIDING:endtimestamp-1
    ind=ind+1;
