...
if G.RUN.FRMTDATA.CORRECTTIMESTAMP,
    ...
    for sensorid=G.RUN.FRMTDATA.SENSORLIST_CORRECTTIMESTAMP
        ...
        if isempty(R.sensor{sensorid}), continue;end;
...
if G.RUN.FRMTDATA.QUALITY,
    for sensorid=G.RUN.FRMTDATA.SENSORLIST_QUALITY
        if sensorid==G.SENSOR.R_RIPID
            ...
            [D.sensor{sensorid}.sample, D.sensor{sensorid}.timestamp,D.sensor{sensorid}.matlabtime]=filter_bad_RIP_NIDA(D.sensor{sensorid}.sample,D.sensor{sensorid}.timestamp,D.sensor{sensorid}.matlabtime);       
