function P=select_groundtruth_gyr(G,pid,sid,P,PICDIR)
for e=1:length(P.smoking_episode)
    ...
    len=length(P.smoking_episode{e}.puff.gyr.starttimestamp);
    P.smoking_episode{e}.puff.gyr.valid=ones(1,len);
end
...
for f=3:length(filenames)
    ...
    if valid==1, 
        ...
        P.wrist{id}.gyr.segment.puff(seg_ind)=-2;
        continue;end;
